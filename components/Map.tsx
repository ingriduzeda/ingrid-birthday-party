        ...
        <section className="py-20 px-4 bg-white relative z-10">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-12">
                    <h2
                        className="text-4xl font-script text-purple-800 mb-4"
                    >
                        Como Chegar
                    </h2>
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-xl border-4 border-purple-100 h-[400px] md:h-[500px]">
                    <iframe
                        src={mapUrl}
                        width="100%"
                        height="100%"
                    ...
                    <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 w-full px-4 md:w-auto">
                        <Button
                            asChild
                            className="bg-white text-purple-800 hover:bg-purple-50 shadow-lg rounded-full px-8 py-6 text-lg font-medium border border-purple-200 w-full md:w-auto"
                        >
                            <a
                                href={locationUrl}
                                target="_blank"
